...
public:
    UpdatePromptComponent(CommonAudioProcessor& processorToUse, juce::String closeButtonSvg)
        ...
        closeButton.onClick = [this] { dismissFor48Hours(); };
    ...
    int getPreferredHeight() const noexcept {
        ...
        return mode == Mode::InstallSucceeded ? 88 : 184;
    }
    ...
    void resized() override {
        ...
        closeButton.setBounds(cardBounds.getRight() - 44, cardBounds.getY() + 14, 28, 28);

        auto area = cardBounds.reduced (28, 22);
        auto titleArea = area.removeFromTop(24);
        titleArea.removeFromRight(38);
